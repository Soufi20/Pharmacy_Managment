...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO supplier (supplier_name, supplier_contact, email) VALUES ('$supplier_name', '$supplier_contact', '$email')";
  ...
  <a href="pharmaacount.php?usernam=<?php echo urlencode($usernam); ?>" target="_blank">
    <span class="material-icons-outlined">settings</span> Account
      ...
      <main class="main-container">
        ...
        <form action="addsupp.php" method="post" id="addMedicineForm" >
          <div class="square">
              <div class="row3">
                  <div class="form-wrapper">
                      <label class="formlab" for="supplier_contact">supplier-name</label>
                      <input type="text" name="supplier_name" id="supplier_name" placeholder="supplier_name" class="formcontact">
                  </div>
                  <div class="form-wrapper">
                      <label class="formlab" for="supplier_contact">supplier_contact</label>
                      <input type="text" name="supplier_contact" id="supplier_contact" placeholder="supplier_contact" class="formcontact">
                  </div>
                  <div class="form-wrapper">
                      <label class="formlab" for="Email">Email</label>
                      <input type="text" name="Email" id="Email" placeholder="Email" class="formcontact">
                  </div>
              </div>
