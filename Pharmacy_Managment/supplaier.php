        ...
        <div class="square">
            <section class="tabbod">
                <table class="table">
                    <thead>
                    <tr>
                        <th style='background-color: #f8f8f8;'>Company</th>
                        <th style='background-color: #f8f8f8;'>PHONE</th>
                        <th style='background-color: #f8f8f8;'>Email</th>
                    ...
                    $sql = "SELECT supplier_id, supplier_name, supplier_contact, email FROM supplier LIMIT $offset, $rows_per_page";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    <td style='background-color: #f8f8f8;'>" . $row["supplier_name"] . "</td>
                                    <td style='background-color: #f8f8f8;'>" . $row["supplier_contact"] . "</td>
                                    <td style='background-color: #f8f8f8;'>" . $row["email"] . "</td>
                                  </tr>";
                        }
                    } else {
                        echo "0 results";
